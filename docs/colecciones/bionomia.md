...
[Bionomia](https://bionomia.net) es una plataforma diseñada para facilitar la atribución de los especímenes publicados en [(GBIF)](https://gbif.org) a los investigadores y taxónomos que han realizado el trabajo de colecta e identificación.   que captura los registros de especímenes publicados en esa plataforma mundial, y los asocia a perfiles de los investigadores por medio de su código de [ORCID](orcid.org). 
{: .fs-5 .fw-300 }
...
El primer paso para obtener un perfil en [Bionomia](https://bionomia.net), es la generación de un perfil en [ORCID](https://orcid.org) con los datos mínimos que permitan la identificación de los investigadores sin lugar a dudas. P

Para crear un perfil, ingresar en la página de [ORCID](https://orcid.org) y dirigirse a la opción "
