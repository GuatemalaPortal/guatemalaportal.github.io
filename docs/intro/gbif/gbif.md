...
4. Una vez los administradores del portal completen la solicitud, el perfil de la colección en el Portal de Biodiversidad va a tener activa la opción de enviar los datos a GBIF. 
