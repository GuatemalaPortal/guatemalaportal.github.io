...
4. Una vez los administradores del portal completen la solicitud, la opción de enviar los datos a GBIF va a aparecer activa en el perfil de la colección en el Portal de Biodiversidad.
